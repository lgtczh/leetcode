...
class SolutionTest {
    ...
    @Test
    void should_return_inorder_traversal_when_tree_has_three_nodes() {
        // 测试用例：三节点树
        TreeNode root = new TreeNode(1);
    ...
    @Test
    void should_return_inorder_traversal_when_tree_is_complete() {
        // 测试用例：完全二叉树
        TreeNode root = new TreeNode(1);
    ...
    @Test
    void should_return_inorder_traversal_when_tree_is_unbalanced() {
        // 测试用例：不平衡二叉树
        TreeNode root = new TreeNode(1);
        root.left = new TreeNode(2);
